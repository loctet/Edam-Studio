...
\begin{lstlisting}
docker exec -it edam-studio bash -c "cd /app/Studio && CLI/cli.sh .run experiment_data"
\end{lstlisting}
This command will:
\begin{enumerate}
...
\begin{lstlisting}
docker exec -it edam-studio bash -c "cd /app/Studio && CLI/cli.sh .run experiment_data --mutation <zip_filename>"
\end{lstlisting}
...
\noindent\textbf{To regenerate from scratch}:
\begin{enumerate}
